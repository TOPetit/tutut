...
import { top_last_errors } from "./Components/Tops/errors";
...
writer.addTile([Tiles.number_of_tutut, Tiles.number_of_errors, Tiles.average_tutut_time, Tiles.number_of_blue_hearts, Tiles.number_missed_reactions]);
writer.addChart([chart_tutut_per_day, chart_tutut_per_minute, line_cumulated_tutut]);
writer.addTop([top_last_tututs, top_first_tututs, top_late_tututs, top_early_tututs, top_last_errors]);
writer.json();
